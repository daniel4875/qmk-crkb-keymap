...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x6_3(KC_TAB, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_ESC, KC_NO, KC_NO, KC_NO, KC_NUBS, KC_GRV, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_QUOT, KC_LSFT, KC_NO, KC_NO, KC_NO, LSFT(KC_NUBS), KC_TILD, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_DQUO, KC_LGUI, MO(3), KC_LCTL, KC_SPC, KC_TRNS, KC_LALT),
	[3] = LAYOUT_split_3x6_3(KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, QK_BOOT, KC_NO, KC_NO, KC_NO, KC_NO, KC_BRIU, KC_VOLU, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_BRID, KC_VOLD, KC_MUTE, KC_NO, KC_NO, KC_NO, KC_RSFT, KC_LGUI, KC_TRNS, KC_LCTL, KC_SPC, KC_TRNS, KC_LALT)
};
